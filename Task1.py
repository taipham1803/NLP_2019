...
visim400 = open(r'/Volumes/Data/Study/NLP/Word-Similarity-master/datasets/ViSim-400/Visim-400.txt', 'r', encoding='utf8')
...
#result.to_csv(r'/Volumes/Data/Study/NLP/Word-Similarity-master/Tasks/Table1.csv', encoding='utf8')
visim400.close()
