...
ant_file = open(r'/Volumes/Data/Study/NLP/Word-Similarity-master/antonym-synonym_set/Antonym_vietnamese.txt', 'r', encoding='utf8')
ant_lines = ant_file.readlines()

pre_trained_file = open(r'/Volumes/Data/Study/NLP/Word-Similarity-master/word2vec/W2V_150.txt', 'r', encoding='utf8')
...
sym_file = open(r'/Volumes/Data/Study/NLP/Word-Similarity-master/antonym-synonym_set/Synonym_vietnamese.txt', 'r', encoding='utf8')
...
vicon400_noun_file = open(r'/Volumes/Data/Study/NLP/Word-Similarity-master/datasets/ViCon-400/400_noun_pairs.txt', 'r', encoding='utf8')
vicon400_noun_lines = vicon400_noun_file.readlines()
read_test_data(vicon400_noun_lines)
vicon400_noun_file.close()

vicon400_verb_file = open(r'/Volumes/Data/Study/NLP/Word-Similarity-master/datasets/ViCon-400/400_verb_pairs.txt', 'r', encoding='utf8')
vicon400_verb_lines = vicon400_verb_file.readlines()
read_test_data(vicon400_verb_lines)
vicon400_verb_file.close()

vicon400_adj_file = open(r'/Volumes/Data/Study/NLP/Word-Similarity-master/datasets/ViCon-400/600_adj_pairs.txt', 'r', encoding='utf8')
